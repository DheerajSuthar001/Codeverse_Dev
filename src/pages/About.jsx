        ...
        <div className='w-full flex justify-center text-white'>
            ...
            <div className='flex flex-col items-center'>
                <div className='w-full bg-richblack-700 flex flex-col items-center'>
                    <section className='w-8/12 flex flex-col gap-10 items-center mt-16 relative '>
                    ...
                    <div className='flex flex-col items-center gap-10 py-10'>
                        ...
                        <div className=' w-8/12 flex gap-10 '>
                            ...
                            <div className='flex-1 flex flex-col gap-5'>
                                ...
                                <p className=' text-richblack-200'>Our e-learning platform was born out of a shared vision and passion for transforming education. It all began with a group of educators, technologists, and lifelong learners who recognized the need for accessible, flexible, and high-quality learning opportunities in a rapidly evolving digital world.</p>
                        ...
                        <div className='w-8/12 flex gap-10 py-10'>
                            {/* left box */}
